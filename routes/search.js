...
module.exports = function(app) {
    ...
    everyone.now.searchLift = function (from_lat, from_lng, to_lat, to_lng, date, fromTolerance, toTolerance) {
        ...
        model.searchByDistance([+from_lng, +from_lat], [+to_lng, +to_lat], fromTolerance, toTolerance, function(lifts) {
